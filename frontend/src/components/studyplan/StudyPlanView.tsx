  ...
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto" }}>
      <div className="hero">
        ...
        <h1>
          Your personalized study <span className="grad-text">dashboard</span>
        </h1>
        <p>
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          ...
          <div className="card">
            ...
            <div style={{ fontSize: "2rem", fontWeight: "bold" }}>
              {studySessions.length - completed}
            </div>
          </div>
        </div>
                ...
                >
                  ...
                  {isPending && (
                    <button
                      className="btn"
                      onClick={() =>
                        handleSessionAction(session.session, "start")
                      }
                    >
                      ▶️ Start Session
                    </button>
                  ...
                  {isInProgress && (
                    <button
                      ...
                      onClick={() =>
                        handleSessionAction(session.session, "complete")
                      }
                    >
                      ✅ Complete Session
                    </button>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            >
              Study time per session (hours): {hours}
            </label>
            <input
              id="hours"
              name="hours"
...
const ProgressComponent = () => {
  return (
    <div>
      ...
      <div
        className="card"
        style={{ marginBottom: "2rem", textAlign: "center", padding: "3rem" }}
      >
        <h3 style={{ marginBottom: "1rem" }}>No Data Available Yet</h3>
        <p style={{ color: "var(--muted)" }}>
          Complete quizzes and study sessions to unlock your progress dashboard,
          weak topics analysis, and revision recommendations.
        </p>
      </div>
    </div>
  );
